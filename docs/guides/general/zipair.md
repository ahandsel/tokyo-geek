...
* **Food is decent** - Small portions, but acceptable taste.
* **Standard seats are narrow** - Smaller than those on JAL or ANA.
* **Extra legroom seats are worth it** - More comfortable than JAL or ANA economy seats.
...
2. Ideally, select **extra legroom seats in the front section** - A small wall provides privacy and storage pockets.
...
* **Size** - Small; consider ordering 2 for a long flight.
...
* Flying from Japan? **Buy food from the 7-Eleven** near the terminal.
  ...
  * Narita website: [7-Eleven Terminal 1][]
...
* **[ZIPAIR Point Club Plus][]** - If you plan to fly ZIPAIR with checked baggage, consider joining the paid membership.
  * **Annual fee**: ¥5,000
  * **Benefit**: 30% discount on checked baggage fees
