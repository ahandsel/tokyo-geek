...
* Google Maps: [Irori Guesthouse Tenmaku / 囲炉裏ゲストハウス天幕][irori-guesthouse]
* Recommended budget accommodation. Private rooms with shared bathrooms are a good value. Try the dinner option with local ingredients cooked over an irori hearth.
* Transport: 3-minute walk from [Chokokunomori station][] on the Hakone Tozan Railway Line.
* Nearby:
  * [Hakone Open-Air Museum][open-air-museum]
  * [CafeDouce][]
...
* [Yumoto station Hotel MIRAHAKONE][]
* Cheap and convenient hotel next to [Hakone-Yumoto][] station.
* It can be noisy because of the nearby road and train station - bring earplugs.
* Located above pizza restaurant 808 Monsmare.
...
* Transport:
  * 2-minute walk from the cable car's [Naka-Gora station][]
  * 14-minute walk or 9-minute cable car ride from [Gora station][].
* Nearby:
  * [Hakone Museum of Art][hakone-museum]
* Notes:
...
* The advertised "discounted entry to attractions" is minor (around ¥100); check sites like [asoview.com][] or [Klook][] for better deals.
* For last-minute travelers, buy the pass via the [Hakone Area EMot Tickets][emot-tickets] app.


### Paper version of the Hakone Freepass

> [!TIP] ⚡ Get the paper Hakone Freepass at Shinjuku or Odawara station.

* Either buy it directly or swap a Klook voucher for the physical paper pass at Shinjuku station or Odawara station.
* The paper pass is more reliable than the e-ticket because cellular reception in Hakone is spotty and many international carriers perform poorly there.
* Pickup locations:
  * [Odakyu Sightseeing Service Center - Shinjuku West (`小田急旅行センター 新宿西口地下`)](https://maps.app.goo.gl/J3uuBYtD8KmEVjnB7)
  * [Odakyu Sightseeing Service Center - Odawara (`小田急旅行センター 小田原`)](https://maps.app.goo.gl/tN5WJ1LMn2JWU4SL6)

> [!WARNING] ⚠️ If you use the e-ticket version, you need cellular data to show it when boarding. Because Hakone is mountainous, reception is often unreliable. Get the paper version to avoid issues.
...
* 08:00 - Breakfast at [COFFEE CAMP][].
* Take the Hakone Tozan Cable Car from [Gora station][] to [Sounzan station][].
* Take the Hakone Ropeway from [Sounzan station][] to [Owakudani station][].
...
> [!TIP] Tip: Create an account on Klook and Asoview.com ahead of time to speed up the booking process.
