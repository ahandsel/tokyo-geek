---
title: '東京のインターネットと携帯電話サービス'
description: '東京でのインターネットとモバイルプランの選び方、店舗でのヒント、支払い方法、プランのアドバイスなどをまとめました。'
head:
  - - meta
    - name: keywords
...
[ヨドバシカメラ（ヨドバシカメラ）][yodobashi-camera]または[ビックカメラ（ビックカメラ）][bic-camera]の店舗に行きましょう。

* これらの大手家電量販店には、プランを比較できる携帯電話コーナーがあり、スタッフも充実しています。
* 主要駅の近くの店舗は、英語対応スタッフがいる可能性が高いです。

ヨドバシカメラやビックカメラのスタッフに相談して、おすすめのプランを聞きましょう。

* 利用可能なプランを確認し、予算やニーズに合った最適なプランを一緒に探してくれます。
* 特定のキャリアに決めていない限り、ブランドブースは避けましょう。

個人的なおすすめ：

* 店舗：[ヨドバシカメラ 新宿西口本店（ヨドバシカメラ 新宿西口本店）][yodobashi-shinjuku-west]
* プラン：SoftBank 光 + YMobile のセットプラン
  * 高速なSoftBank 光の光回線で、在宅勤務にも安定しています。
