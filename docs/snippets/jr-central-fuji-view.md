---
title: Shinkansen seating tip
description: Sit on the D or E side of the Tokaido Shinkansen when traveling from Tokyo to Kyoto for the best view of Mt. Fuji.
...
```mermaid
xychart-beta
  title "Travel time from Tokyo (minutes)"
  x-axis ["Nozomi","Hikari","Kodama"]
  y-axis "Minutes" 0 --> 250
  bar "Kyoto" [132,160,219]
  bar "Shin-Osaka" [147,174,234]
```
