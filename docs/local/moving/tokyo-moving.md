...
description: Tips on setting up internet and cell service, buying home essentials, and finding resources when relocating to Tokyo.
head:
  - - meta
    - name: keywords
      content: tokyo, moving, expats, cell service, home setup
---
...
_Trying to find a cell phone plan in Japan?_

Go to a [Yodobashi Camera (ヨドバシカメラ)][yodobashi-camera] or [Bic Camera (ビックカメラ)][bic-camera] store.

* These big electronics stores have well-staffed cell phone sections where you can browse various plans.
* Stores near major stations also tend to have more English-speaking staff.

Talk with staff at Yodobashi or Bic Camera and ask for a recommendation.

* They will go over the available plans and help you pick the best one for your needs and budget.
* ⚡ Avoid the branded booths unless you are certain you want their plan.

Personal recommendation:

* Store: [Yodobashi Camera Shinjuku West Main Store (ヨドバシカメラ 新宿西口本店)][yodobashi-shinjuku-west]
* Plan: SoftBank 光 + YMobile bundle plan
  * Reliable for working at home with the fast SoftBank 光 fiber internet connection.
...
* YMobile is a budget-friendly cell phone plan with the same coverage as SoftBank.
  * YMobile works well for coverage in rural areas (mountains, beaches, etc.).
...
* The easiest way to pay for your cell phone plan is with a credit card.
* Japan Post Bank is the most straightforward option for opening a bank account.
  * For more information, refer to the [How to open a Japan Post Bank account - MATCHA][matcha-japan-post-bank] article.
...
* Generally, data-only plans do not support phone calls or SMS (text messages).
  * Suitable for those who have company phones.
...
Closest equivalent to Home Depot.

Near central Tokyo:

* [Viva Home Toyosu / スーパービバホーム 豊洲店][viva-home-toyosu]
* [Kohnan Koto Fukagawa Store / コーナン江東深川店][kohnan-koto-fukagawa]

[viva-home-toyosu]: https://goo.gl/maps/joP3skD6cFqW3RG99
[kohnan-koto-fukagawa]: https://goo.gl/maps/c5gas35kiGSvoWMe9
...
* Even if it is small, it makes a huge difference in simplifying laundry days.
* EN: Compact clothes dryer
* JP: 小型衣類乾燥機
* Solid size for a small apartment: 3.0 kg to 4.0 kg

Recommendation:

* EN: My Wave Warm Dryer 3.0
* JP: マイウェーブ ウォームドライヤー3.0
* Amazon: [Product page][amazon-my-wave]
* Keepa (price tracker): [Keepa listing][keepa-my-wave]

[amazon-my-wave]: https://www.amazon.co.jp/dp/B06XBBNMRX/
[keepa-my-wave]: https://keepa.com/#!product/5-B06XBBNMRX


## Other resources for living in Tokyo

* [Living in Tokyo: city life tips for newcomers - Time Out Tokyo][time-out-living]
* [Living in Tokyo - Tokyo Cheapo][tokyo-cheapo-living]
* [Living Archives - Metropolis Japan][metropolis-living]

[time-out-living]: https://www.timeout.com/tokyo/city-life/your-guide-to-living-in-tokyo
[tokyo-cheapo-living]: https://tokyocheapo.com/living/
[metropolis-living]: https://metropolisjapan.com/living/


## Useful websites for locals
