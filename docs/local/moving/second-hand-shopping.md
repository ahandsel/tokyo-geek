---
title: 'Buying second-hand furniture and appliances'
description: 'How to find second-hand furniture and appliances in Japan.'
head:
  - - meta
    - name: keywords
...
[Mercari][mercari] (`メルカリ`) is a popular Japanese app for buying and selling used items. It functions similarly to eBay.

* Instead of meeting in person, items are shipped via Japan Post or Yamato Transport.
* Website UX can be translated to Japanese via [user settings][mercari-lang-settings] but the user-generated content is all in Japanese.
* Instead of their app, use the website version to use browser translation features.
