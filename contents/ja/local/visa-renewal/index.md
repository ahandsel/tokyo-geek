...
[マイナンバーカード オンライン申請][my-number-card-apply]にアクセスして、マイナンバーカードをお持ちでない場合は申請してください。紙の通知カードではなく、IC チップと写真付きの物理カードが必要です。
...
[マイナンバーカード対応 IC カードリーダライタの一覧][ic-card-reader-list]

> [!TIP]
> Android スマートフォンをお持ちの場合は、[JPKI 利用者ソフト][jpki-android-app]アプリをインストールして、IC カードリーダーとして使うこともできます。
...
* まずこの[YouTube の動画チュートリアル][utm-youtube-tutorial]を見てから設定すると、スムーズにセットアップできます。

UTM に Windows 11 をインストールする手順の概要：

1. [UTM][utm-official]をインストールして、Mac 上で Windows VM を実行します。
   * 選択肢 1：[公式サイトからダウンロード][utm-official] - 完全に無料でオープンソースです。
   * 選択肢 2：[Mac App Store で購入][utm-app-store]（$9.99）で開発者を支援。
     * App Store 版はアップデートと管理が簡単ですが、[公式 Microsoft サイト][microsoft-windows11]から無料版をダウンロードすることもできます。
2. Windows 11 の ISO ファイルをダウンロード - [CrystalFetch][crystalfetch]を使うか、Microsoft から直接ダウンロードします。
...
詳しい手順は[UTM 公式ドキュメントの Windows 11 インストールガイド][utm-docs-windows]をご覧ください。


#### 方法 2：Parallels Desktop - 有料だが簡単

[Parallels Desktop][parallels-desktop]をインストールして、Mac 上で Windows VM を実行します。
...
* [日本在留資格オンライン申請（在留資格线上申請） - YouTube][visa-online-youtube]
...
* [JPKI アプリ（JPKI 利用者ソフト）][jpki-win-download]
* [最新の Java アップデート（Java8 Update 371）][java-download]
  * パッケージマネージャーではなく、直接ダウンロードしてください。
  * 「JRE」や「Java Runtime Environment」は Java のことです。
* [利用者クライアントソフト Edge/Chrome - Chrome ウェブストア][jpki-client-chrome]
...
* 問題：Windows インストーラーの代わりに`UEFI Iterative Shell v2.2`の黒い画面が表示される。
  ...
  * ![UEFI Iterative Shell v2.2 画面のスクリーンショット][img-windows-black-shell]
...
* ![JPKI 利用者ソフト実行時の文字化けエラーメッセージ][img-jpki-broken-error]
...
* ![利用者クライアントソフトエラー エラーコード：EW000J0200 のスクリーンショット][img-jpki-reader-error]
...
* ![JPKI 利用者ソフトの EW104J1502 エラー][img-jpki-error-ew104j1502]
...
* [日本のビザ更新（オンライン・窓口）ガイド - Tokyo Cheapo][tokyo-cheapo-visa]
...
[jpki-client-chrome]: https://chromewebstore.google.com/detail/%E5%88%A9%E7%94%A8%E8%80%85%E3%82%AF%E3%83%A9%E3%82%A4%E3%82%A2%E3%83%B3%E3%83%88%E3%82%BD%E3%83%95%E3%83%88-edgechrome/ddhaancdmkmeigppopkakhpbboccibla?hl=ja
[jpki-prepare-juki]: https://www.jpki.go.jp/prepare/juki.html
[jpki-win-download]: https://www.jpki.go.jp/download/win.html
[microsoft-windows11]: https://www.microsoft.com/software-download/windows11
[my-number-card-apply]: https://www.kojinbango-card.go.jp/en-mynumber/
[online-residence-system]: https://www.moj.go.jp/isa/applications/online/onlineshinsei.html?hl=en
...
[utm-docs-windows]: https://docs.getutm.app/guides/windows/
[utm-official]: https://mac.getutm.app/
[utm-youtube-tutorial]: https://www.youtube.com/watch?v=hdddzyIPasU
[visa-online-youtube]: https://www.youtube.com/watch?v=IWJOFH99NpM
