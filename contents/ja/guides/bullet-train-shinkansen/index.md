...
新幹線のきっぷを購入できるウェブサイトは 3 つあります：

* SmartEX - JR 東海が運営。英語に完全対応しています。
* Eki-net.com - JR 東日本が運営。英語に一部対応しています。
* Klook - 新幹線のきっぷを販売するサードパーティのウェブサイトです。

3 つのウェブサイトの比較は以下の通りです：
...
東海道・山陽・九州新幹線のきっぷを買うなら、SmartEX の利用をおすすめします。

* SmartEX は JR 東海が運営しており、オンラインでも駅窓口でも充実したサポートが受けられます。
* SmartEX は英語対応で、比較的使いやすいです。
...
1. Tokyo
2. Shinagawa
3. Shin-Yokohama（Yokohama 駅の近く）
4. Nagoya
5. Kyoto
6. Shin-Osaka（Osaka 駅の近く）
7. Shin-Kobe
8. Okayama
9. Hiroshima
10. Kokura
11. Hakata
12. Kumamoto
13. Kagoshima-Chuo（Kagoshima 駅の近く）
...
* SmartEX は東海道・山陽・九州新幹線のきっぷのみに対応しています。
  * その他の新幹線路線には Eki-net または Klook をご利用ください。
* SmartEX はジャパンレールパスやその他のパスとの併用はできません。
...
* 同じきっぷで列車の種類（特急と各停）を混在させることはできません。
  * 例：最初の列車でのぞみを利用し、次の列車でひかりを利用する場合は、2 枚のきっぷが必要です。
