...
* データ通信のみなら[eSIM の方法](#esimの方法)がおすすめです。電話もしたい場合は[音声 + データ付き eSIM](#音声データ付きesim)を検討してください。ただし、1〜2 人なら予約に電話番号は必要ありません。
...
* もう 1 つの方法は、[eSIM の方法](#esimの方法)を使い、仕事が必要なときに[コワーキングスペース](https://tokyocheapo.com/business/drop-in-coworking-spaces-tokyo/)を利用することです。


### グループ旅行の場合

* 1 人が[音声 + データ付き eSIM](#音声データ付きesim)を使って日本の電話番号を取得しましょう。この人が予約やサービスの登録を担当できます。
* 他のメンバーは[eSIM の方法](#esimの方法)でデータ通信のみを利用しましょう。
...
1. [eSIM の方法](#esimの方法) - 旅行用 eSIM プロバイダーから eSIM を購入する。
