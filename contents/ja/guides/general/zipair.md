---
title: ZIPAIR のヒント
description: ZIPAIR の座席選び、機内食、荷物ポリシーなどの実用的なメモです。
head:
  - - meta
    - name: keywords
...
* **通常席は狭い** - JAL や ANA より狭いです。
* **足元の広い席はおすすめ** - JAL や ANA のエコノミー席より快適です。
* 追加の荷物、食事、機内持ち込みアイテムは**フライトの 3 時間前まで**追加料金なしで追加できます。
...
* 座席は**JAL や ANA より狭い**です。
* ノートパソコンではなく、iPad やタブレットを使いましょう。
  * 座席にはタブレットやスマートフォン用のスタンドがあります。
  * 座席が狭くてノートパソコンは使いにくいです。
  * 機内エンターテインメントはありません。
* 充電ポート：
  * USB-A 充電ポートは問題なく使えます。
  * 座席の電源プラグは不安定で、角度的にプラグが抜けやすいです。
* おやつや飲み物をたくさん持っていきましょう。
* **座席 19D と 19E の間にはハードな仕切りがありません**。
